...
ver_file = os.path.join(currentdir, '..', project, '_version.py')
...
man_pages = [
    ('index', 'PyShearlets', 'PyShearlets Documentation',
     ['Gregory R. Lee'], 1)
]
...
texinfo_documents = [
  ('index', 'PyShearlets', 'PyShearlets Documentation',
   'Gregory R. Lee', 'PyShearlets', 'One line description of project.',
   'Miscellaneous'),
]
